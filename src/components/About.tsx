...
const projects = [
{
  ...
  description: 'Data Science Capstone Project: Data quality scoring for EHR (Electronic Health Record) datasets (completeness/plausibility/conformance) with anomaly detection and synthetic error testing.',
